...
let validate = true;
let setting_text = ' Due in 1 week, Results visible to everyone, Show correct answer';
...
$(document).on("change", ".form_time input, .form_date input, .visible-to, #show-correct-answer", function() {
    ...
    if (days == undefined || days == NaN) {
        ...
        var correct_answer = $('#show-correct-answer:eq(0)').is(":checked") == true ? ', Show correct answer' : '';
                    ...
                    <div class="row">
                        <div class="col-9">
                            <a class="theme-color cursur-pointer show-setting" id="hide1">
                                ...
                                <span id="due"> Due in 1 week, Results visible to everyone, Show correct answer</span>
                            </a>
